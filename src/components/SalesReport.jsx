            ...
            <div className="bg-white p-6 rounded-lg shadow-md overflow-x-auto">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full table-auto border-collapse">
                        <thead>
                            <tr>
                                <th className="py-3 px-4 text-center border-b border-gray-300">Seller</th>
                                <th className="py-3 px-4 text-center border-b border-gray-300">Customer</th>
                                <th className="py-3 px-4 text-center border-b border-gray-300">Products</th>
                                ...
                                <th className="py-3 px-4 text-center border-b border-gray-300">Total Amount</th>
                                <th className="py-3 px-4 text-center border-b border-gray-300">Date</th>
                            </tr>
                        </thead>
                        <tbody>
